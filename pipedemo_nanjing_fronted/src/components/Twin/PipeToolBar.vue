    ...
    <div class="toolbar-icons">
        ...
        <div v-if="activeToolIndex === 0" class="icon-extension">
          <div class="extension-content">
            ...
            <div class="label-icon" @click="handleResetDigCut">
              <img src="@/assets/pngs/pipetoolbar/label1.png" style="width: 18px; height: 18px" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div v-if="activeToolIndex === 1" class="icon-extension">
          <div class="extension-content">
            ...
            <div class="label-icon" @click="handleResetElevation">
              <img src="@/assets/pngs/pipetoolbar/label2.png" style="width: 18px; height: 18px" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div v-if="activeToolIndex === 3" class="icon-extension">
          <div class="extension-content">
            ...
            <div class="label-icon" @click="handlePipeHidden">
              <img src="@/assets/pngs/pipetoolbar/label3.png" style="width: 18px; height: 18px" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="icon-container" :class="{ 'icon-container-expanded': activeToolIndex === 11 }">
        ...
        <div v-if="activeToolIndex === 11" class="icon-extension">
          <div class="extension-content">
            ...
            <div class="extension-divider"></div>
            <div class="label-icon" @click="handleResetSceneStyle">
              <img src="@/assets/pngs/pipetoolbar/label2.png" style="width: 18px; height: 18px" />
            </div>
          </div>
        </div>
        ...
        <div v-if="isPipeEditorExpand" class="icon-extension">
          <div class="extension-content">
            ...
            <div class="label-icon">
              <img src="@/assets/pngs/pipetoolbar/label4.png" style="width: 18px; height: 18px" />
            </div>
          </div>
        </div>
      </div>
      ...
      <transition name="fade-card">
        <div v-if="
          ...
          activeToolIndex === 6 ||
          activeToolIndex === 11
        " class="pipe-toolbar-attri-card" :style="{ left: `${toolLeftOffset}px` }">
          <!-- PNG 背景 -->
          <img class="pipe-toolbar-attri-card_bg" src="@/assets/pngs/pipetoolbar/pipe_attri_card.png"
          ...
          <div class="pipe-toolbar-attri-card_content">
            ...
            <div v-if="activeToolIndex === 2" class="light-box">
              <div class="light-row">
                <label class="light-label">管网类型：</label>
                <!-- <el-select v-model="lightPieType" placeholder="请选择管网类型" class="light-select" size="small">
                  <el-option label="雨水管线" value="rain_line" />
                  <el-option label="污水管线" value="sewage_line" />
                  <el-option label="雨水管井" value="rain_node" />
                  <el-option label="污水管井" value="sewage_node" />
                </el-select> -->
                <BaseSelect v-model="lightPieType" :options="hightOptions" placeholder="请选择管网类型" />
              </div>

              <div class="light-row">
                <label class="light-label">亮度：</label>
                <el-slider v-model="lightIntensity" size="small" :show-tooltip="false" />

                <el-color-picker v-model="lightColor" show-alpha color-format="hex" size="small" />
              </div>
            </div>
            ...
            <div v-if="activeToolIndex === 3" class="light-box">
              <div class="light-row">
                <label class="light-label">管网类型：</label>
                <!-- <el-select v-model="visiblePieType" placeholder="请选择管网类型" class="light-select" size="small">
                  <el-option label="雨水管线" value="rain_line" />
                  <el-option label="污水管线" value="sewage_line" />
                  <el-option label="雨水管井" value="rain_node" />
                  <el-option label="污水管井" value="sewage_node" />
                </el-select> -->
                <BaseSelect v-model="visiblePieType" :options="hightOptions" placeholder="请选择管网类型" />
              </div>

              <div class="light-row">
                <label class="light-label">特定管段：</label>
                <el-input-tag v-model="visiblePipeIds" collapse-tags collapse-tags-tooltip max-collapse-tags="1"
                  tag-type="info" tag-effect="dark" clearable size="small" placeholder="请输入指定管段的ID"
            ...
            <div v-if="activeToolIndex === 5" class="light-box">
              <div class="light-row">
                <label class="light-label">管网类型：</label>
                <!-- <el-select v-model="liquidPipeType" placeholder="请选择管网类型" class="light-select" size="small">
                  <el-option label="雨水管线" value="rain_line" />
                  <el-option label="污水管线" value="sewage_line" />
                  <el-option label="雨水管井" value="rain_node" />
                  <el-option label="污水管井" value="sewage_node" />
              ...
              <div class="light-row">
                ...
                <div class="custom-number">
                  ...
                  <el-input v-model="liquidLevel" style="width: 100px; height: 24px" />
            ...
            <div v-if="activeToolIndex === 6" class="light-box">
              ...
              <div class="light-row">
                ...
                <!-- <el-select v-model="flowStyle" placeholder="请选择流向样式" class="light-select" size="small">
                  <el-option label="样式1" value="0" />
                  <el-option label="样式2" value="1" />
                  <el-option label="样式3" value="2" />
                </el-select> -->
                <BaseSelect v-model="flowStyle" :options="flowStyleOptions" placeholder="请选择流向样式" />
              </div>

              <div class="light-row">
                <label class="light-label">流向方向：</label>
                <!-- <el-select v-model="flowDirection" placeholder="请选择流向方向" class="light-select" size="small">
                  <el-option label="正向" value="1" />
                  <el-option label="反向" value="0" />
                </el-select> -->
                <BaseSelect v-model="flowDirection" :options="flowDirectionOptions" placeholder="请选择流向方向"
                  class="flowDirection-select" />
                <el-color-picker v-model="flowColor" show-alpha color-format="hex" size="small" />
              </div>
            </div>
...
const hightOptions = [
  { label: "雨水管线", value: "rain_line" },
  { label: "污水管线", value: "sewage_line" },
...
const toolLeftOffset = computed(() => {
  ...
  if (activeToolIndex.value == null) return 0
  ...
  const visualIndex =
    visualIndexMap[activeToolIndex.value] ?? activeToolIndex.value

  return visualIndex * itemWidth + offset
})

const cardHeight = computed(() => {
  switch (activeToolIndex.value) {
    case 6:
      return '151px'
    case 11:
      return '192px'
...
.flowDirection-select :deep(.trigger) {
  width: 110px;
}

/* 下拉也跟着变宽（可选） */
.flowDirection-select :deep(.dropdown) {
  min-width: 110px;
}

:deep(.el-color-picker-panel) {
  background-color: rgba(28, 49, 77, 0.6) !important;
}
</style>