<template>
  <div class="base-select" ref="root">
    ...
    <div class="trigger" :class="{ open: isOpen, disabled: disabled }" @click="toggle">
      ...
      <!-- 倒三角 -->
      <svg class="arrow" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" width="9.024999618530273"
        height="5.300000190734863" viewBox="0 0 9.024999618530273 5.300000190734863">
        <path
    ...
    <Transition name="fade">
      <div v-if="isOpen" class="dropdown">
        <div v-for="opt in options" :key="opt.value" class="option" :class="{ active: isSelected(opt.value) }"
          @click="select(opt)">
          {{ opt.label }}
        </div>
...
.base-select {
  ...
  background: url("@/assets/pngs/BG/pipetoolbar/select.png") no-repeat center/ 100% 100%;
  width: 180px;
  height: 24px;
