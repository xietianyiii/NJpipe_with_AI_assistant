<template>
    <div class="loading-overlay">
        ...
        <div class="status-bar">
            <div class="status-item" v-for="(item, i) in statusItems" :key="i" :style="{ animationDelay: i * 0.3 + 's' }">
...
const steps = [
    ...
    { delay: 3500, value: 50 },
    { delay: 4900, value: 80 },
    { delay: 5900, value: 100 },
]

steps.forEach(({ delay, value }) => {
    setTimeout(() => { progress.value = value }, delay)
})
</script>
...
.dot-2 { top: 25%;  left: 100%; transform: translate(-50%, -50%); animation-delay: 0.33s; }
.dot-3 { top: 75%;  left: 100%; transform: translate(-50%, -50%); animation-delay: 0.66s; }
.dot-4 { top: 100%; left: 50%;  transform: translate(-50%, -50%); animation-delay: 1s; }
.dot-5 { top: 75%;  left: 0%;   transform: translate(-50%, -50%); animation-delay: 1.33s; }
.dot-6 { top: 25%;  left: 0%;   transform: translate(-50%, -50%); animation-delay: 1.66s; }
...
.loading-bars > div:nth-child(4) { animation-delay: -0.7s; }
.loading-bars > div:nth-child(1),
.loading-bars > div:nth-child(5) { animation-delay: -0.5s; }
